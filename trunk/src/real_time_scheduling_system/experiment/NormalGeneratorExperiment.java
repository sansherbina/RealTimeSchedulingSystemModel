...
public class NormalGeneratorExperiment implements IExperiment{

	@Override
	public DataMass makeExperiment(ModelSettings modelSettings,
			List<MachineConfiguration> machineConfigurations) {
		IRandomGenerator randomGenerator=new NormalGenerator(modelSettings.getNormalDistributionM(), modelSettings.getNormalDistributionSigma());
