...
public class Test {
	public static void main(String[] args){
		...
		machinesList.add(new Machine(new MachineConfiguration(0, 10, new double[]{10,15}, 0)));
		machinesList.add(new Machine(new MachineConfiguration(1, 10, new double[]{10,15}, 1)));
		machinesList.add(new Machine(new MachineConfiguration(2, 10, new double[]{10,15}, 2)));
		...
		ExecutionCostMatrixBuilder executionCostMatrixBuilder=new ExecutionCostMatrixBuilder(new TaskOnMachineRelationCalculator());
		ExecutionCostMatrix executionCostMatrix=executionCostMatrixBuilder.buildExecutionCostMatrix(tasksList, machinesList);
		System.out.println(executionCostMatrix.toString());
		TaskScheduling randomSched=TaskScheduling.generateRandomScheduling(executionCostMatrix);
