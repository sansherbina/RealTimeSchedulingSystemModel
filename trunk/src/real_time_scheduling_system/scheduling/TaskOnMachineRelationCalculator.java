...
public class TaskOnMachineRelationCalculator implements
		ITaskOnMachineRelationCalculator {

	@Override
	public double calculateTaskMachineRelation(Task task,
			MachineConfiguration machineConfiguration) {
		double memmoryRelation = machineConfiguration.getMemmoryCapacity()
				/ task.getMemmoryCapactity();
